# Даны два неупорядоченных набора целых чисел (с повторениями). Выдать без повторений в порядке возрастания все те числа, которые встречаются в обоих наборах. Пользователь вводит 2 числа. n — кол-во элементов первого множества. m — кол-во элементов второго множества. Затем пользователь вводит сами элементы множеств.

# import random

# size_1 = int(input('Input the amount of elements for the first list: '))
# print(list_1 := ([random.randint(0, 10) for _ in range(size_1)]))

# size_2 = int(input('Input the amount of elements for the second list: '))
# print(list_2 := ([random.randint(0, 10) for _ in range(size_2)]))
...
# size_1 = int(input("The amount of bushes: "))
# print(bush := ([random.randint(0, 20) for _ in range(size_1)]))
